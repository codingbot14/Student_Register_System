...
def Clear():    
    ...
    img1=PhotoImage(file='SQL/upload photo.png')
...
def Save():
    ...
    if N1=="" or C1=="Select Class" or D2=="" or Re1=="" or S1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":
        ...
        try:
            img.save("SQL/Student Images/"+str(R1)+".jpg")
        except:
        ...
        registration_no()    #it will recheckregistration no. and reissue new no.    
...
##           print(reg_number)
  ...
  #but reg_number just showing number after A2 like 2,3,......,n
   ...
   #print(x4)
    ...
    img = (Image.open("SQL/Student Images/"+str(x1)+".jpg"))
    resized_image=img.resize((190,190))
    photo2 = ImageTk.PhotoImage(resized_image) 
    lbl.config(image=photo2)
    lbl.image=photo2       
...
def update():
   ...
   # sheet.cell(column=1,row=int(reg_number),value=R1)  now noone can update registration no. , it will
...
#top frames
Label(root,text="Email: worldyaseen123@gmail.com",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
...
img=PhotoImage(file="SQL/upload photo.png")
